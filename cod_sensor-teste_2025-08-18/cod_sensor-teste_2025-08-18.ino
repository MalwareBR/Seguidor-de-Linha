...
void setup()
{
  ...
  //Esquerda 22,21,19,18,5,17,16,4
  //Direita 13, 12, 14, 27, 26, 25, 33, 32
  //Sequencia 4,16,17,5,18,19,21,22,32,33,25,26,27,14,12,13
  //qtr.setEmitterPin();
...
void loop()
{
  ...
  // reflectance and   means minimum reflectance, followed by the line
  // position
  for (uint8_t i = 0; i < SensorCount; i++)
  {
